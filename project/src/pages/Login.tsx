...
const Login = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['overview', 'coe', 'highlights', 'content', 'why-this-works', 'coordinator', 'certificate'];
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-blue-50/30 min-h-screen scroll-smooth">
      ...
      {/* PAGE BODY — full-width two-column layout */}
      <div className="flex flex-col lg:flex-row">

        {/* ── LEFT COLUMN: hero + all sections, scrolls normally ── */}
        <div className="w-full lg:w-3/5 xl:w-7/12">

          {/* HERO LEFT */}
          <div className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-blue-50/30 px-4 sm:px-6 lg:px-10 xl:px-16 py-10 sm:py-12 lg:py-14 space-y-4 sm:space-y-5">
          ...
          <div className="px-6 py-10 space-y-12 text-gray-700">
