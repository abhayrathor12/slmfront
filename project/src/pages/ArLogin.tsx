                ...
                <div className="mt-5 pt-4 border-t border-gray-100">
                    ...
                    <div className="space-y-1.5">
                        {[
                            ...
                            { href: "mailto:contact@xrforge.io", icon: <Mail size={13} className="text-[#203f78]" />, label: "contact@xrforge.io" },
                            { href: "https://www.xrforge.io", icon: <Globe size={13} className="text-[#203f78]" />, label: "www.xrforge.io" },
                        ].map(({ href, icon, label }) => (
